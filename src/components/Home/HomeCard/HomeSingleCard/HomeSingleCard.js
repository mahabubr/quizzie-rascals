    ...
    return (
        <div className='border border-zinc-700  rounded-2xl shadow-2xl'>
            ...
            <div className='p-8'>
                ...
                <Link to={`/quiz/${id}`} className='bg-orange-500 hover:bg-orange-600 duration-500 rounded-lg py-3 w-full font-bold shadow-2xl mt-4 flex justify-center items-center text-white'>
                    <p>Start Practice</p>
